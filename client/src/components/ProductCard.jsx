  ...
  return (
    <>
      <article
        ...
        className="group cursor-pointer overflow-hidden rounded-lg sm:rounded-xl border border-mint bg-white shadow-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-glow"
      >
        <div className="overflow-hidden">
          <img src={product.image} alt={product.name} className="img-card object-cover transition duration-500 group-hover:scale-105" />
        </div>
        <div className="p-3 sm:p-4">
          ...
          <div className="mt-3 flex flex-col gap-2 sm:gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="btn-primary w-full sm:w-auto text-xs sm:text-sm px-3 sm:px-4 py-2 sm:py-2.5"
            >
              Add to Cart
            </button>
          </div>
